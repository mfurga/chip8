...
class Opcode(object):
    ...
    def execute_clear_or_return_instruction(self):
        """Executes the clear or return instruction."""
        try:
    ...
    def execute_bitwise_instruction(self):
        """Executes the bitwise instructions."""
        try:
    ...
    def execute_misc_instruction(self):
        """Executes the misc instructions."""
        try:
    ...
    def decrement_registers(self):
        """Decrements the sound timer & the delay timer registers."""
        if self.vm.dt > 0:
            self.vm.dt -= 1
        if self.vm.st > 0:
            self.vm.st -= 1
